...
if "%6"=="rtgmc"			(set "MODE=--vpp-rtgmc preset=medium,input_type=0,source_match=3,lossless=2")
if "%6"=="rtgmcp"			(set "MODE=--vpp-rtgmc preset=medium,input_type=1,source_match=3,lossless=0")
